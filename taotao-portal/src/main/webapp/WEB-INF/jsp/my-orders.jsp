                                ...
                                <c:forEach items="${orderList}" var="order">
                                    ...
                                    <tr class="tr-th">
                                        <td colspan="6">
                                            <span class="tcol1">
                                                订单编号:
                                                <a name="orderIdLinks" href="#">${order.orderId}</a>
                                            </span>
                                        ...
                                        <div class="img-list">
                                            <c:forEach items="${order.orderItems}" var="item" begin="0" end="3">
                                                <a href="/item/${item.itemId}.html" class="img-box" clstag="click|keycount|orderinfo|order_product" target="_blank">
                                                    <img title="${item.itemId}" width="50" height="50" src="${item.picPath}" class="err-product">
                                                </a>
                                            </c:forEach>
                                        </div>
                                    ...
                                    <td>
                                        ￥${order.payment}<br> 货到付款
                                        <br>
                                    </td>
                                    <td>
                                        <span class="ftx-03">${order.time}</span>
                                        <input type="hidden" id="datasubmit-${order.orderId}" value="2014-10-20 22:30:49">
                                    </td>

                                    <td><span class="ftx-03">${order.status}</span></td>

                                    <td id="operate${order.orderId}" class="order-doi" width="100">

                                        <span id="pay-button-${order.orderId}" state=""></span>
                                        <a target="_blank" href="#" clstag="click|keycount|orderinfo|order_check">查看</a>
                                        <span id="order_comment"></span><span class="pop-recycle-a">|
				                            <a href="javascript:void(0)" clstag="click|keycount|orderinfo|order_del" >删除</a>
			                            </span>
                                            <span id="doi${order.orderId}"><br>
                                            <a href="#" target="_blank" clstag="click|keycount|orderinfo|order_comment">评价晒单</a><br>
                                        </span>
                                        <a href="#" target="_blank" clstag="click|keycount|orderinfo|order_repair">申请返修/退换货</a>
                                        <a class="btn-again" clstag="click|keycount|orderlist|buy" href="#" target="_blank">还要买</a>
                                    </td>
                                    </tr>
                                    </tbody>
                                </c:forEach>
