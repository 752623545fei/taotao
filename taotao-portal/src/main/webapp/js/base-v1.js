...
function login() {
    ...
    return location.href = "http://sso.hongde508.top/user/showLogin?redirect= " + document.URL + "";
}
function regist() {
    return location.href = "http://sso.hongde508.top/user/showRegister";
}
...
function search(a) {
    var b = "http://www.hongde508.top/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
